...
func PrepareAccountsForDelegationRewards(t *testing.T, ctx sdk.Context, app *app.omini, addr sdk.AccAddress, balance math.Int, rewards ...math.Int) (sdk.Context, error) {
	...
	err := FundModuleAccount(ctx, app.BankKeeper, distrAcc.GetName(), sdk.NewCoins(sdk.NewCoin(ominitypes.BaseDenom, totalRewards)))
	if err != nil {
