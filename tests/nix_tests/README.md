...
different omini and [Geth](https://github.com/ethereum/go-ethereum) clients with multiple configurations.
...
If you're changing anything on the omini rpc, rerun the first command.
