...
def test_block(omini_cluster, geth):
    # Perform block queries (eth_getBlockByNumber & eth_getBlockByHash)
    # on omini and geth nodes, and compare the responses
    # Case 1: block without transactions
    get_blocks(omini_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(omini_cluster, geth, True)


def get_blocks(omini_rpc_ws, geth, with_transactions):
    w3: Web3 = omini_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    omini_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [omini_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(omini_cluster, geth):
...
def test_syncing(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(omini_cluster, geth):
    # on omini the proof query will fail for block numbers <= 2
...
def test_get_code(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(omini_cluster, geth):
    w3: Web3 = omini_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(omini_cluster, geth):
...
def test_incomplete_send_transaction(omini_cluster, geth):
