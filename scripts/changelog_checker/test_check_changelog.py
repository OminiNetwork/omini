...
class TestParseChangelog:
        ...
        expected_result = {
            "Unreleased": {
                "State Machine Breaking": {
                    ...
                    1687: {"description": "Bump omini version to v14."},
                },
                "API Breaking": {
                    2015: {
                ...
                "Improvements": {
                    ...
                    701: {"description": "Rename Go module to `omini/omini`."},
                },
                "Bug Fixes": {
    ...
    def test_fail(self):
        ...
        assert changelog.problems == [
            'PR link is not matching PR number 1948: "https://github.com/omini/omini/pull/1949"',
