...
def test_check_if_in_exempt_files_not_included():
    file = "/Users/malte/dev/go/omini/omini/app/app.go"
    assert cl.check_if_in_exempt_files(file) is False


def test_check_if_in_exempt_files_included():
    file = "/Users/malte/dev/go/omini/omini/x/erc20/keeper/proposals.go"
    assert cl.check_if_in_exempt_files(file) is True

    file = "/Users/malte/dev/go/omini/omini/x/erc20/types/utils.go"
    assert cl.check_if_in_exempt_files(file) is True

    file = "/Users/malte/dev/go/omini/omini/x/evm/genesis.go"
    assert cl.check_if_in_exempt_files(file) is False
