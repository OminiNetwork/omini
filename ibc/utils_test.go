...
import (
	...
	teststypes "github.com/omini/omini/v20/types/tests"
)

func init() {
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("omini", "ominipub")
}
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1",
				Receiver: "omini1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Amount:   "123456",
			},
			expSender:    "",
			expRecipient: "",
		...
		{
			name: "valid - cosmos sender, omini recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Receiver: "omini1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Amount:   "123456",
			},
			expSender:    "omini1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expRecipient: "omini1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expError:     false,
		},
		{
			name: "valid - omini sender, cosmos recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "omini1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Receiver: "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Amount:   "123456",
			},
			expSender:    "omini1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expRecipient: "omini1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expError:     false,
		},
		{
			name: "valid - osmosis sender, omini recipient",
			data: transfertypes.FungibleTokenPacketData{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/aomini",
			"10",
			sdk.Coin{Denom: "aomini", Amount: math.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			"get unwrapped aomini coin",
			baseDenom,
			"10",
			sdk.Coin{Denom: baseDenom, Amount: math.NewInt(10)},
		},
		{
			"get ibc wrapped aomini coin",
			"transfer/channel-0/aomini",
			"10",
			sdk.Coin{Denom: teststypes.AominiIbcdenom, Amount: math.NewInt(10)},
		},
		{
...
func TestDeriveDecimalsFromDenom(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expDec:    0,
			expFail:   true,
			expErrMsg: "Should be either micro ('u[...]') or atto ('a[...]'); got: \"nomini\"",
		},
		{
