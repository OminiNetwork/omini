	...
	testCases := []struct {
	...
	}{
		{
			...
			banktypes.Metadata{
				...
				Name:        "omini",
				Symbol:      "omini",
				Description: "EVM, staking and governance denom of omini",
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "aomini",
						Exponent: 0,
						Aliases:  []string{"atto omini"},
					},
					{
						Denom:    "omini",
						Exponent: 18,
...
func TestEqualAliases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			[]string{"atto omini", "aomini"},
			[]string{"aomini", "atto omini"},
			false,
		},
		{
			"same values, sorted",
