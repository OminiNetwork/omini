...
import (
	...
	"github.com/omini/omini/v20/ibc"
...
// registered via governance. Note that the native staking denomination (e.g. "aomini"),
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	case pair.IsNativeERC20():
		...
		// assume that all module accounts on omini need to have their tokens in the
