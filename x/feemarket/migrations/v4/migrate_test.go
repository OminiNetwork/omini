// Copyright 2022 omini Foundation
// This file is part of the omini Network packages.
//
// omini is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The omini packages are distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the omini packages. If not, see https://github.com/omini/omini/blob/main/LICENSE
package v4_test
...
import (
	...
	v4 "github.com/omini/omini/v20/x/feemarket/migrations/v4"
