...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "omini.epochs.v1.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "omini.epochs.v1.GenesisState")
}

func init() { proto.RegisterFile("omini/epochs/v1/genesis.proto", fileDescriptor_c74bc0b3e7fa01c2) }
