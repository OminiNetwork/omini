...
func init() {
	proto.RegisterType((*QueryBalancesRequest)(nil), "omini.vesting.v2.QueryBalancesRequest")
	proto.RegisterType((*QueryBalancesResponse)(nil), "omini.vesting.v2.QueryBalancesResponse")
}

func init() { proto.RegisterFile("omini/vesting/v2/query.proto", fileDescriptor_e31744b0ce27e85a) }
...
func (c *queryClient) Balances(ctx context.Context, in *QueryBalancesRequest, opts ...grpc.CallOption) (*QueryBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/omini.vesting.v2.Query/Balances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/omini.vesting.v2.Query/Balances",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "omini.vesting.v2.Query",
	...
	Metadata: "omini/vesting/v2/query.proto",
}
