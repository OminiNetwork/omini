...
func init() {
	proto.RegisterType((*EventCreateClawbackVestingAccount)(nil), "omini.vesting.v2.EventCreateClawbackVestingAccount")
	proto.RegisterType((*EventFundVestingAccount)(nil), "omini.vesting.v2.EventFundVestingAccount")
	proto.RegisterType((*EventClawback)(nil), "omini.vesting.v2.EventClawback")
	proto.RegisterType((*EventUpdateVestingFunder)(nil), "omini.vesting.v2.EventUpdateVestingFunder")
}

func init() { proto.RegisterFile("omini/vesting/v2/events.proto", fileDescriptor_7a6fa6478193a613) }
