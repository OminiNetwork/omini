...
import (
	...
	_ "github.com/omini/omini/v20/server/config/migration" // Add this import to set up the proper app.toml migration logic for sdk v0.50
)
...
const (
	...
	DefaultRosettaDenomToSuggest = "aomini"
...
func AppConfig(denom string) (string, interface{}) {
	...
	//
	// In omini, we set the min gas prices to 0.
	if denom != "" {
