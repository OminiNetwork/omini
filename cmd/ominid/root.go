...
import (
	...
	ominiclient "github.com/omini/omini/v20/client"
	"github.com/omini/omini/v20/client/block"
	"github.com/omini/omini/v20/client/debug"
	ominiserver "github.com/omini/omini/v20/server"
	servercfg "github.com/omini/omini/v20/server/config"
...
func NewRootCmd() (*cobra.Command, sdktestutil.TestEncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(ominikr.Option()).
		WithViper(EnvPrefix).
	...
	ominiserver.AddCommands(
		rootCmd,
		ominiserver.NewDefaultStartOptions(a.newApp, app.DefaultNodeHome),
		a.appExport,
		addModuleInitFlags,
	)
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		ominiclient.KeyCommands(app.DefaultNodeHome),
	)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		ominiApp = app.Newomini(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), appOpts, app.ominiAppOptions)

		if err := ominiApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		ominiApp = app.Newomini(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), appOpts, app.ominiAppOptions)
	}

	return ominiApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
