...
func init() {
	file_omini_inflation_v1_inflation_proto_init()
	md_InflationDistribution = File_omini_inflation_v1_inflation_proto.Messages().ByName("InflationDistribution")
...
func (x *InflationDistribution) slowProtoReflect() protoreflect.Message {
	mi := &file_omini_inflation_v1_inflation_proto_msgTypes[0]
...
func (x *fastReflection_InflationDistribution) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "omini.inflation.v1.InflationDistribution.staking_rewards":
		return x.StakingRewards != ""
	case "omini.inflation.v1.InflationDistribution.usage_incentives":
		return x.UsageIncentives != ""
	case "omini.inflation.v1.InflationDistribution.community_pool":
		return x.CommunityPool != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: omini.inflation.v1.InflationDistribution"))
		}
		panic(fmt.Errorf("message omini.inflation.v1.InflationDistribution does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_InflationDistribution) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message omini.inflation.v1.InflationDistribution does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_InflationDistribution) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "omini.inflation.v1.InflationDistribution.staking_rewards":
		panic(fmt.Errorf("field staking_rewards of message omini.inflation.v1.InflationDistribution is not mutable"))
	case "omini.inflation.v1.InflationDistribution.usage_incentives":
		panic(fmt.Errorf("field usage_incentives of message omini.inflation.v1.InflationDistribution is not mutable"))
	case "omini.inflation.v1.InflationDistribution.community_pool":
		panic(fmt.Errorf("field community_pool of message omini.inflation.v1.InflationDistribution is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: omini.inflation.v1.InflationDistribution"))
		}
...
func (x *fastReflection_InflationDistribution) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in omini.inflation.v1.InflationDistribution", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_omini_inflation_v1_inflation_proto_init()
	md_ExponentialCalculation = File_omini_inflation_v1_inflation_proto.Messages().ByName("ExponentialCalculation")
...
func (x *ExponentialCalculation) slowProtoReflect() protoreflect.Message {
	mi := &file_omini_inflation_v1_inflation_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ExponentialCalculation) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "omini.inflation.v1.ExponentialCalculation.a":
		return x.A != ""
	case "omini.inflation.v1.ExponentialCalculation.r":
		return x.R != ""
	case "omini.inflation.v1.ExponentialCalculation.c":
		return x.C != ""
	case "omini.inflation.v1.ExponentialCalculation.bonding_target":
		return x.BondingTarget != ""
	case "omini.inflation.v1.ExponentialCalculation.max_variance":
		return x.MaxVariance != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: omini.inflation.v1.ExponentialCalculation"))
		}
		panic(fmt.Errorf("message omini.inflation.v1.ExponentialCalculation does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ExponentialCalculation) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message omini.inflation.v1.ExponentialCalculation does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ExponentialCalculation) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "omini.inflation.v1.ExponentialCalculation.a":
		panic(fmt.Errorf("field a of message omini.inflation.v1.ExponentialCalculation is not mutable"))
	case "omini.inflation.v1.ExponentialCalculation.r":
		panic(fmt.Errorf("field r of message omini.inflation.v1.ExponentialCalculation is not mutable"))
	case "omini.inflation.v1.ExponentialCalculation.c":
		panic(fmt.Errorf("field c of message omini.inflation.v1.ExponentialCalculation is not mutable"))
	case "omini.inflation.v1.ExponentialCalculation.bonding_target":
		panic(fmt.Errorf("field bonding_target of message omini.inflation.v1.ExponentialCalculation is not mutable"))
	case "omini.inflation.v1.ExponentialCalculation.max_variance":
		panic(fmt.Errorf("field max_variance of message omini.inflation.v1.ExponentialCalculation is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: omini.inflation.v1.ExponentialCalculation"))
		}
...
func (x *fastReflection_ExponentialCalculation) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in omini.inflation.v1.ExponentialCalculation", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: omini/inflation/v1/inflation.proto
...
// The initial InflationDistribution can be calculated from the omini Token
// Model like this:
...
func (*InflationDistribution) Descriptor() ([]byte, []int) {
	return file_omini_inflation_v1_inflation_proto_rawDescGZIP(), []int{0}
}
...
func (*ExponentialCalculation) Descriptor() ([]byte, []int) {
	return file_omini_inflation_v1_inflation_proto_rawDescGZIP(), []int{1}
}
...
var File_omini_inflation_v1_inflation_proto protoreflect.FileDescriptor

var file_omini_inflation_v1_inflation_proto_rawDesc = []byte{
...
var (
	file_omini_inflation_v1_inflation_proto_rawDescOnce sync.Once
	file_omini_inflation_v1_inflation_proto_rawDescData = file_omini_inflation_v1_inflation_proto_rawDesc
)

func file_omini_inflation_v1_inflation_proto_rawDescGZIP() []byte {
	file_omini_inflation_v1_inflation_proto_rawDescOnce.Do(func() {
		file_omini_inflation_v1_inflation_proto_rawDescData = protoimpl.X.CompressGZIP(file_omini_inflation_v1_inflation_proto_rawDescData)
	})
	return file_omini_inflation_v1_inflation_proto_rawDescData
}

var file_omini_inflation_v1_inflation_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_omini_inflation_v1_inflation_proto_goTypes = []interface{}{
	(*InflationDistribution)(nil),  // 0: omini.inflation.v1.InflationDistribution
	(*ExponentialCalculation)(nil), // 1: omini.inflation.v1.ExponentialCalculation
}
var file_omini_inflation_v1_inflation_proto_depIdxs = []int32{
...
func init() { file_omini_inflation_v1_inflation_proto_init() }
func file_omini_inflation_v1_inflation_proto_init() {
	if File_omini_inflation_v1_inflation_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_omini_inflation_v1_inflation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_omini_inflation_v1_inflation_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_omini_inflation_v1_inflation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_omini_inflation_v1_inflation_proto_goTypes,
		DependencyIndexes: file_omini_inflation_v1_inflation_proto_depIdxs,
		MessageInfos:      file_omini_inflation_v1_inflation_proto_msgTypes,
	}.Build()
	File_omini_inflation_v1_inflation_proto = out.File
	file_omini_inflation_v1_inflation_proto_rawDesc = nil
	file_omini_inflation_v1_inflation_proto_goTypes = nil
	file_omini_inflation_v1_inflation_proto_depIdxs = nil
}
