...
func init() {
	file_omini_vesting_v1_vesting_proto_init()
	md_ClawbackVestingAccount = File_omini_vesting_v1_vesting_proto.Messages().ByName("ClawbackVestingAccount")
...
func (x *ClawbackVestingAccount) slowProtoReflect() protoreflect.Message {
	mi := &file_omini_vesting_v1_vesting_proto_msgTypes[0]
...
func (x *fastReflection_ClawbackVestingAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "omini.vesting.v1.ClawbackVestingAccount.base_vesting_account":
		return x.BaseVestingAccount != nil
	case "omini.vesting.v1.ClawbackVestingAccount.funder_address":
		return x.FunderAddress != ""
	case "omini.vesting.v1.ClawbackVestingAccount.start_time":
		return x.StartTime != nil
	case "omini.vesting.v1.ClawbackVestingAccount.lockup_periods":
		return len(x.LockupPeriods) != 0
	case "omini.vesting.v1.ClawbackVestingAccount.vesting_periods":
		return len(x.VestingPeriods) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: omini.vesting.v1.ClawbackVestingAccount"))
		}
		panic(fmt.Errorf("message omini.vesting.v1.ClawbackVestingAccount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ClawbackVestingAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message omini.vesting.v1.ClawbackVestingAccount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ClawbackVestingAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "omini.vesting.v1.ClawbackVestingAccount.vesting_periods":
		...
		return protoreflect.ValueOfList(value)
	case "omini.vesting.v1.ClawbackVestingAccount.funder_address":
		panic(fmt.Errorf("field funder_address of message omini.vesting.v1.ClawbackVestingAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: omini.vesting.v1.ClawbackVestingAccount"))
		}
...
func (x *fastReflection_ClawbackVestingAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in omini.vesting.v1.ClawbackVestingAccount", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: omini/vesting/v1/vesting.proto
...
func (*ClawbackVestingAccount) Descriptor() ([]byte, []int) {
	return file_omini_vesting_v1_vesting_proto_rawDescGZIP(), []int{0}
}
...
var File_omini_vesting_v1_vesting_proto protoreflect.FileDescriptor

var file_omini_vesting_v1_vesting_proto_rawDesc = []byte{
...
var (
	file_omini_vesting_v1_vesting_proto_rawDescOnce sync.Once
	file_omini_vesting_v1_vesting_proto_rawDescData = file_omini_vesting_v1_vesting_proto_rawDesc
)

func file_omini_vesting_v1_vesting_proto_rawDescGZIP() []byte {
	file_omini_vesting_v1_vesting_proto_rawDescOnce.Do(func() {
		file_omini_vesting_v1_vesting_proto_rawDescData = protoimpl.X.CompressGZIP(file_omini_vesting_v1_vesting_proto_rawDescData)
	})
	return file_omini_vesting_v1_vesting_proto_rawDescData
}

var file_omini_vesting_v1_vesting_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_omini_vesting_v1_vesting_proto_goTypes = []interface{}{
	(*ClawbackVestingAccount)(nil),     // 0: omini.vesting.v1.ClawbackVestingAccount
...
var file_omini_vesting_v1_vesting_proto_depIdxs = []int32{
	1, // 0: omini.vesting.v1.ClawbackVestingAccount.base_vesting_account:type_name -> cosmos.vesting.v1beta1.BaseVestingAccount
	2, // 1: omini.vesting.v1.ClawbackVestingAccount.start_time:type_name -> google.protobuf.Timestamp
	3, // 2: omini.vesting.v1.ClawbackVestingAccount.lockup_periods:type_name -> cosmos.vesting.v1beta1.Period
	3, // 3: omini.vesting.v1.ClawbackVestingAccount.vesting_periods:type_name -> cosmos.vesting.v1beta1.Period
...
func init() { file_omini_vesting_v1_vesting_proto_init() }
func file_omini_vesting_v1_vesting_proto_init() {
	if File_omini_vesting_v1_vesting_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_omini_vesting_v1_vesting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_omini_vesting_v1_vesting_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_omini_vesting_v1_vesting_proto_goTypes,
		DependencyIndexes: file_omini_vesting_v1_vesting_proto_depIdxs,
		MessageInfos:      file_omini_vesting_v1_vesting_proto_msgTypes,
	}.Build()
	File_omini_vesting_v1_vesting_proto = out.File
	file_omini_vesting_v1_vesting_proto_rawDesc = nil
	file_omini_vesting_v1_vesting_proto_goTypes = nil
	file_omini_vesting_v1_vesting_proto_depIdxs = nil
}
